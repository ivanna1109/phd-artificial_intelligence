...
with open('initial_results/gcn/model_summary-gcn.txt', 'w') as f:
    model.summary(print_fn=lambda x: f.write(x + '\n'))
print("Zavrseno pisanje u fajl.")

print("Pisemo history treninga..")
history_df = pd.DataFrame(history.history)
history_df.to_csv('initial_results/gcn/gcn_history.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights('initial_results/gcn/gcn_model.h5')
