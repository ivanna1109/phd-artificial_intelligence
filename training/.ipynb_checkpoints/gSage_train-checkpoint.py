...
from new_training.models.gSage import GraphSageModel
import pandas as pd
...
model = GraphSageModel(num_features, classes_num, hidden_units, dense_units, dropout_rate)
...
with open('initial_results/gSage/model_summary-moreActiveABCDE.txt', 'w') as f:
    model.summary(print_fn=lambda x: f.write(x + '\n'))
print("Zavrseno pisanje u fajl.")

print("Pisemo history treninga..")
history_df = pd.DataFrame(history.history)
history_df.to_csv('initial_results/gSage/gSage_history_moreActiveABCDE.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights('initial_results/gSage/gSage_model_moreActiveABCDE.h5')
