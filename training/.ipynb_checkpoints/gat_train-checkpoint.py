...
with open('initial_results/gat/model_summary-gat_moreActiveABCDE.txt', 'w') as f:
    model.summary(print_fn=lambda x: f.write(x + '\n'))
print("Zavrseno pisanje u fajl.")

print("Pisemo history treninga..")
history_df = pd.DataFrame(history.history)
history_df.to_csv('initial_results/gat/gat_history_moreActiveABCDE.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights('initial_results/gat/gat_model_moreActiveABCDE.h5')
