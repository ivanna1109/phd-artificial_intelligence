...
import training.multiclassification.spektral_data_multi.tf_to_spektral as tf_to_s
from training.multiclassification.spektral_data_multi.spektral_dataset import MyDataset
import training.metrics.calculate_metrics as metric
from training.models_for_multi.gcn_multi import GCN_MultiClass
import optuna
...
dataset_dir = '/home/ivanam/BIO-Info/bio_info/data_preprocessing/data/tfrecords_multi_balanced'
...
def objective(trial):
    ...
    model = GCN_MultiClass(num_features, num_labels, hidden_units, dense_units, dropout_rate)
    ...
    history_df.to_csv(f'training/multiclass_results/optuna_tuning/gcn/history_results_{i}.csv', index=False)
    i+=1
...
output_file_path = "training/multiclass_results/optuna_tuning/gcn/optuna_results.txt" 
